...
dms()
{
    terraform apply \--var-file=$path \--target module.backend.aws_instance.dms \--target module.backend.aws_lb_target_group.dms_tg \--target module.backend.aws_lb_target_group_attachment.dms \--target module.backend.aws_lb_listener_rule.dms --auto-approve
